...
export default function BuySellSection() {
  ...
  // Calculate USDT amount based on rupee input (for buy)
  ...
  // Calculate Rupee amount based on USDT input (for sell)
  ...
  return (
    <div className="bg-black text-white h-full flex items-center justify-center p-4 sm:p-8 max-w-4xl mx-auto">
      <div className="w-full space-y-4">
        {/* Wallet Balance Card */}
        <div className="bg-[#101010] max-w-md border border-[#3E3E3E] rounded-md p-3 mx-auto">
        ...
        <div className="flex justify-center max-w-md space-x-3 sm:space-x-6 mx-auto mb-6 sm:mb-10">
        ...
        {/* Buy/Sell Tabs */}
        <div className="flex space-x-3 sm:space-x-6 max-w-lg mx-auto mb-6 sm:mb-8">
          <button
        ...
        {/* Payment Method Selection - Only show when a tab is selected */}
        {activeTab && (
          <div className="bg-gray-900/30 border border-[#3E3E3E] rounded-md p-4 sm:p-5 mb-6 sm:mb-8">
        ...
        {/* Amount Input Section - Only show when payment method is selected */}
        {activeTab && paymentMethod && (
          <div className="bg-[#101010] border border-[#3E3E3E] rounded-md p-4 sm:p-5">
        ...
        {/* Action Button - Only show when payment method is selected */}
        {activeTab && paymentMethod && (
          <button className="w-full bg-[#622DBF] hover:bg-purple-700 text-white py-4 sm:py-5 px-6 rounded-xl font-bold text-lg sm:text-xl transition-all shadow-lg shadow-purple-600/25 hover:shadow-purple-600/40">
            {activeTab === 'buy' ? 'Buy' : 'Sell'}
          </button>
        )}

        {/* How to buy/sell link - Only show when tab is selected */}
        {activeTab && (
          <div className="text-center pt-2">
            <button className="flex items-center space-x-2 text-white hover:text-white transition-colors mx-auto group">
